...
function Read-RGMatrixFromExcel {
  ...
  # We expect two side-by-side blocks on the same sheet:
  #   PRODUCTION:     A-C (A:resource_group_name, B:role_definition_name, C:ad_group_name)
  #   NONPRODUCTION:  F-H (F:resource_group_name, G:role_definition_name, H:ad_group_name)
